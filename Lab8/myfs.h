...
#define FS_FREE_LIST_SIZE 50
#define FS_FREE_INODE_SIZE 10
...
typedef struct
{
    u_int32_t free_list[FS_FREE_LIST_SIZE];         // list of free blocks
    u_int32_t free_inode_list[FS_FREE_INODE_SIZE];  // list of free inodes
    int32_t reserved;
